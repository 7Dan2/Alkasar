...
$sql = "INSERT INTO Mensuelle (ID_Mensuelle, Date, h_clim1_EN2, h_clim2_EN2, h_clim1_EMB, h_clim2_EMB, h_clim1_CCR, h_clim2_CCR,
 ...
 h_clim1_sh_comcept, h_clim2_sh_comcept, h_GF1_A1, h_GF1_B1, h_GF2_A1, h_GF2_B1, h_comp_air_CCR, h_comp_air_dem1_GE_EN2, h_comp_air_dem2_GE_EN2, 
 h_GE1_EN2, h_GE2_EN2, h_GE1_EN3, h_GE2, EN3, h_GE1_23, h_GE2_23,
 h_diesel_vernon, h_diesel_et_asi_vernon, GO_cit1_30k, GO_cit2_30k, GO_cit1_23, GO_cit_vernon)
VALUES ('$_POST[id]', '$_POST[date]', '$_POST[en2_1]',  '$_POST[en2_2]', '$_POST[emb_1]', '$_POST[emb_2]', '$_POST[ccr_1]', '$_POST[ccr_2]', 
'$_POST[tec1_1]', '$_POST[tec1_2]', '$_POST[tec2_1]', '$_POST[tec2_2]', '$_POST[tec3_1]', '$_POST[tec3_2]', '$_POST[localTransfo]',
'$_POST[sathena1]', '$_POST[sathena2]', '$_POST[scomcept1]', '$_POST[scomcept2]', '$_POST[gf1a1j]', '$_POST[gf1b1j]', '$_POST[gf2a1j]', '$_POST[gf2b1j]',
'$_POST[compccr]', $_POST[comp1demge]', '$_POST[comp2demge]', '$_POST[ge10035]', '$_POST[ge20035]', '$_POST[ge10104]', '$_POST[ge20104]',
