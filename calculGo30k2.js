...
{
    let getFuelHeigtValue = document.getElementById("lectureFioul30k2").value;
    console.log("valeur lue jauge citerne 30k numéro 2 :" + " " + getFuelHeigtValue);
...
document.getElementById("fuelRestant30k2").innerHTML = fuelRemainInTank;
