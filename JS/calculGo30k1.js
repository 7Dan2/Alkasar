...
function calculGo30k1()
{
    ...
    let getFuelHeigtValue = document.getElementById("lectureFioul30k1").value;
    console.log("valeur lue jauge citerne 30k numéro 1 :" + " " + getFuelHeigtValue);
    ...
    document.getElementById("fuelRestant30k1").innerHTML = fuelRemainInTank;
